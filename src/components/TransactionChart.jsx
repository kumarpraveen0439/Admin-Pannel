...
{/* <div className="w-full sm:w-1/2 h-[22rem] bg-white p-4 rounded-sm border border-gray-200 flex flex-col"> */}
...
export default function TransactionChart() {
  return (
    <div className="w-full sm:w-1/2 h-[22rem] bg-white p-4 rounded-sm border border-gray-200 flex flex-col lg:flex-1">
      <strong className="text-gray-700 font-medium">Transactions</strong>
      <div className="mt-3 w-full flex-1 text-xs">
        <ResponsiveContainer width="100%" height="100%">
